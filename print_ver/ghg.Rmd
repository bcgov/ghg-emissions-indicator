...
ghg_pop + theme_print + 
  labs(caption = 
    ...
    included in the B.C. inventory were removed for this calculation, as these emission sources are not 
    tracked everywhere. More details on these emissions are available below.")
```
