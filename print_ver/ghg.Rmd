...
Major energy-related sources of greenhouse gas emissions include transportation, such as driving cars, and stationary combustion sources, such as oil and gas extraction.
...
* In `r max_ghg_yr`, British Columbia's total greenhouse gas emissions were `r abs(baseline_year)`% `r ifelse(baseline_year > 0, "more", "less")` than the 2007 baseline year.
...
* Overall, greenhouse gas emissions per person in British Columbia---also called per capita---have declined since the 2007 baseline year, however they have shown increases in recent reporting years.
...
- The energy sector produces the largest amount of greenhouse gas emissions in British Columbia. This sector includes numerous sources relating to energy production, storage and use. Recent increases in greenhouse gas emissions in B.C. come largely from this sector---mostly from transportation and oil and gas extraction.
...
- The larger sources of greenhouse gas emissions within the energy sector include road transportation and stationary combustion sources, such as oil and gas extraction, manufacturing and heating residential buildings.
