...
-   Per capita and economic greenhouse gas intensities are based on gross emissions totals. Values reported differ from those used in the Climate Change Accountability Report^2^, which uses net emissions totals to calculate corresponding intensities.\vspace{.2cm}
...
-   The transportation sector produces the largest amount of greenhouse gas emissions in British Columbia. Passenger transport (trucks, SUV's, small cars, motorcycles) and freight transport (heavy duty trucks and rail) produce the most emissions within the transportation sector.
...
-   Heavy industry's emissions generally trended downward since 2000 with some fluctuations. Deforestation emissions declined from 1990 to 2005, after which they have remained consistent.

-   Buildings emissions have fluctuated between 1990 and 2021, currently approximately 1.5 Mt CO~2~e higher than 1990 levels. 

-  Emissions from the agriculture, light industry, electricity, and waste sectors have fluctuated over the past three decades, but at a lower magnitude (< 1 Mt CO~2~e) than other sectors.
