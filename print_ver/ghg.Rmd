...
* `r max_ghg_yr` emissions were `r round(reduction_mt, digits=1)` million tonnes of carbon dioxide equivalent `r ifelse(cleanbc_reduction > 0, "more", "less")` than B.C.'s interim 2025 target. 
