...
title: "Trends in Greenhouse Gas Emissions in B.C. (1990-2017)"
...
* In `r max_ghg_yr`, British Columbia's total greenhouse gas emissions were `r abs(baseline_year)`% less than the 2007 baseline year, with relatively small and variable changes in total emissions in recent reporting years.
...
Published and Available On-Line at Environmental Reporting BC (September 2019):   
