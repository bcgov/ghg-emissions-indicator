...
* Overall, greenhouse gas emissions per person in British Columbia---also called per capita---have declined since the 2007 baseline year, however they have shown increases in recent reporting years. These increases come largely from energy use - mostly from transportation, and oil and gas extraction to a lesser degree.
...
- The energy sector produces the largest amount of greenhouse gas emissions in British Columbia. This sector includes numerous sources relating to energy production, storage and use. 
