...
cat("- In each economic sector figure below, the grey background shows the total emissions from each sector over time and the color sections show the contribution of each subsector compared to the sector total.\n")
