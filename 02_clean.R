...
library(reshape2) #convert dataframe from wide to long format
library(dplyr) #pipe function, data manipulation


##making 'normalized' data set with gdpdata file for comparison of measures
...
ghgmelt <- reshape2::melt(ghgdata, id.vars=c("sector","subsector_level1","subsector_level2","subsector_level3"),
