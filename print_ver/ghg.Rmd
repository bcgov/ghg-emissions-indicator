...
-   **Different greenhouse gases have contributed varying proportions of total greenhouse gas emissions across time.** In 2021, carbon dioxide comprised the overwhelming majority of emissions (CO~2~, 84.1%), followed by methane (CH~4~, 10.7%), nitrous oxide (N~2~O, 2.6%), hydroflourocarbons (HFCs, 2.5%), with perflourocarbons (PFCs) and sulphur hexaflouride (SF~6~) close to zero. 
...
-   A total of 6 greenhouse gases: carbon dioxide, hydroflourocarbons, methane, nitrous oxide, perfluorocarbons and sulphur hexafluoride, are monitored across B.C. For the purpose of the below figures, values for each greenhouse gas have been converted to their CO~2~ equilvalent, allowing for comparison of effect size.

- The relative contribution (measured in MtCO~2~e) of greenhouse gases emitted in 2021 was carbon dioxide (84.1%), methane (10.7%), nitrous oxide (2.6%), hydroflourocarbons (2.5%), perflourocarbons (0.2%) and sulphur hexaflouride (0%).
...
\newpage
## Change in individual Greenhouse Gas emissions over time

-   Carbon dioxide (CO~2~) emissions have fluctuated over time between since 1990 levels, and have increased by 6.5 MtCO~2~e as of 2021.

-   Hydroflourocarbons (HFCs) have gradually increased since 1990, peaking in 2020 at an increase of 1.6  MtCO~2~e

- Methane (CH~4~) has been consistenyly higher than early levels, however has shown a steep decline as of 2018 and currently 0.8  MtCO~2~e less than 1990 levels.

- Nitrous oxide has shown little change from 1990 levels, peaking at a 0.5  MtCO~2~e increase in 2004, but since declining close to original levels.

-   Perflourocarbons (PFCs) have gradually declined, and currently are 1.1  MtCO~2~e less than 1990 levels

-   Sulphur hexaflouride (SF~6~), which has the highest radiative forcing potential of all recorded gases, but has never been more than 0.1  MtCO~2~e, and has been zero since 2011.
